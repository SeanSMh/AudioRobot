package com.example.sean.audiorobot;
...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    private void initSpeech() {
        ...
        SpeechUtility.createUtility(this, SpeechConstant.APPID + "=5bad811f");
    }

    @Override
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_startspeech: //语音识别（把声音转文字） 申请动态权限
    ...
    private void startSpeechDialog() {   //设置语音对话框
        ...
        //3.设置回调接口
        mDialog.setListener(new MyRecognizerDialogListener());  //注册监听器
        //4. 显示dialog，接收语音输入
        mDialog.show();
    }
            ...
            try {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        *语音播报
                        * */
                        AudioUtil audioUtil = new AudioUtil(MainActivity.this);
                        audioUtil.speaking(text);
                        adapter.notifyItemInserted(msgList.size() - 1);//当有新消息时，刷新recycler View中的显示
                        msgRecyclerView.scrollToPosition(msgList.size() - 1);//将recycler view定位到最后一行
                    }
                });
